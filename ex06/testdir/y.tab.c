...
static const char *const yytname[] =
{
  ...
  "','", "'!'", "'('", "')'", "$accept", "list", "body", "body2", "$@1",
  "elem", "expr", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,   259,    43,    42,    91,    93,    44,
      33,    40,    41
};
# endif
...
{
      16,    17,    11,     1,    16,    17,    15,    19,     3,    12,
      20,    21,     7,     8,     9,    17,    10,     0,    18
};

static const yytype_int8 yycheck[] =
{
       5,     6,     4,     7,     5,     6,    12,    12,     3,    11,
      16,    17,     0,    10,     8,     6,     9,    -1,    14
};
...
{
       0,     7,    14,     3,    15,    16,    18,     0,    10,     8,
       9,     4,    11,    19,    17,    19,     5,     6,    18,    12,
      19,    19
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 44 "../strlist.y" /* yacc.c:1646  */
    { printf("\nThe length of list is %d\n",(yyvsp[-1].num)); }
#line 1229 "y.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 47 "../strlist.y" /* yacc.c:1646  */
    { (yyval.num) = 0; }
#line 1235 "y.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 48 "../strlist.y" /* yacc.c:1646  */
    { (yyval.num) = (yyvsp[0].num); }
#line 1241 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 51 "../strlist.y" /* yacc.c:1646  */
    { (yyval.num) = (yyvsp[0].num); }
#line 1247 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 52 "../strlist.y" /* yacc.c:1646  */
    { printf(","); }
...
#line 1259 "y.tab.c" /* yacc.c:1646  */
  ...
  case 8:
#line 55 "../strlist.y" /* yacc.c:1646  */
    { printf("%s",(yyvsp[0].str)->c_str()); (yyval.num) = 1; }
#line 1265 "y.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 56 "../strlist.y" /* yacc.c:1646  */
    { int i;
                          if ((yyvsp[0].num) <= 0)
                            compileError(EIllegalExpValue,(yyvsp[0].num));
                          else  {
			    printf("%s",(yyvsp[-2].str)->c_str());
			    for (i=1; i<(yyvsp[0].num); i++)
			      printf(",%s",(yyvsp[-2].str)->c_str());
			  }
			  (yyval.num) = (yyvsp[0].num);
			}
#line 1280 "y.tab.c" /* yacc.c:1646  */
  ...
  case 10:
#line 68 "../strlist.y" /* yacc.c:1646  */
    { (yyval.num) = (yyvsp[-2].num) + (yyvsp[0].num); }
#line 1286 "y.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 69 "../strlist.y" /* yacc.c:1646  */
    { (yyval.num) = (yyvsp[-2].num) * (yyvsp[0].num); }
#line 1292 "y.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 70 "../strlist.y" /* yacc.c:1646  */
    { (yyval.num) = (yyvsp[0].num); }
#line 1298 "y.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 71 "../strlist.y" /* yacc.c:1646  */
